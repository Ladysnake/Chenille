...
------------------------------------------------------
**Changes**
- Chenille now uses the Github URL setting to preconfigure the Github release extension

------------------------------------------------------
Version 0.21.1
------------------------------------------------------
**Fixes**
- Fixed Curseforge release not working (thanks again to Up)
...
**Removals**
- Removed Jfrog Artifactory maven setup helper

------------------------------------------------------
Version 0.17.1
------------------------------------------------------
**Fixes**
- Fixed publishing tasks requiring remap tasks on 26.1+
